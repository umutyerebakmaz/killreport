import { Corporation, CorporationResolvers, CorporationsResponse, PageInfo, QueryResolvers } from '../generated-types';
...
export const corporationQueries: QueryResolvers = {
    ...
    corporations: async (_, { first, after }): Promise<CorporationsResponse> => {
        const take = first || 25;
