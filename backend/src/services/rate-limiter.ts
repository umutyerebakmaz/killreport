...
class RateLimiter {
  ...
  private readonly maxRequestsPerSecond = 100; // Conservative (ESI allows 150)
  private readonly minDelayBetweenRequests = 20; // 20ms minimum between requests (50 req/sec per worker)
