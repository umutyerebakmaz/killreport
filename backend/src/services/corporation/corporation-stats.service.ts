/**
 * Corporation Statistics Service
 *
 * Handles independent queries for corporation statistics (top targets)
...
/**
 * Get top 10 ship types used by a corporation (as attacker)
...
/**
 * Invalidate all corporation stats cache for a given corporation
 * Call this when new killmails are added for this corporation
 */
export async function invalidateCorporationStats(
  corporationId: number,
): Promise<void> {
