...
import { KillmailService } from './src/services/killmail/index.js';
import prisma from './src/services/prisma.js';
import './src/src/config.js';
...
async function fetchAndSaveKillmail() {
    try {
        ...
        const detail = await KillmailService.getKillmailDetail(KILLMAIL_ID, hash);
