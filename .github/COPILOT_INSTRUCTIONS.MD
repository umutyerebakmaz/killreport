...
**Pre-aggregated Tables**: O(1) lookup for maximum performance
...
- Views refresh every 5 minutes via cron job
...
- **Current day/week/month**: 300 seconds (5 min) - aligns with MV refresh rate
