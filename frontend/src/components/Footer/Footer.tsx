...
const navigation = {
  ...
  tools: [
    { name: "EVE SSO Login", href: "/login" },
    { name: "Real-time Updates", href: "/" },
    { name: "Advanced Search", href: "/killmails" },
  ],
  legal: [
    { name: "Terms of Service", href: "#" },
    { name: "Privacy Policy", href: "#" },
    {
      name: "EVE License Agreement",
      href: "https://community.eveonline.com/support/policies/eve-eula-en/",
    },
  ],
  social: [
    {
      name: "X",
      href: "https://x.com/killreport",
      icon: (props: any) => (
