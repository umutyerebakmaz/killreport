      ...
      >
        {options.map((option) => (
          <ListboxOption
            ...
            className="relative py-2 pl-8 pr-4 text-gray-200 transition-colors cursor-pointer select-none group data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden data-disabled:cursor-not-allowed data-disabled:text-ink-faint data-disabled:opacity-50"
          >
